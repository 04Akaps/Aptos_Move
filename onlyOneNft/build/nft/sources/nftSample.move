...
use std::signer;
    ...
    entry fun init_module (owner : &signer) {
        let name  =  string::utf8(b"ZEP");
        let description = string::utf8(b"Metaverse ZEP");
        ...
        assert!(!exists<ZEPNftWeb3>(@publisher), E_HAS_CAPABILITIES);
    ...
    public entry fun create_whiteList (
        ...
        let nft_data = borrow_global_mut<ZEPNftWeb3>(owner);
    ...
    public entry fun mint_nft_by_user(
        ...
        let nft_data = borrow_global_mut<ZEPNftWeb3>(receiver_address);
    ...
    public entry fun mint_nft_to_Owner(
        ...
        assert!(exists<ZEPNftWeb3>(@publisher), E_HAS_CAPABILITIES);
        let nft_data = borrow_global_mut<ZEPNftWeb3>(@publisher);
